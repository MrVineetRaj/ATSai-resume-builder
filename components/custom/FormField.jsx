    ...
    <span className="relative w-full">
      {type === "textarea" ? (
        <textarea
          ...
          className="p-2 outline-none border-2 w-full text-sm 
          focus:border-primary valid:border-primary rounded-md smooth-animation peer "
          required={true}
          rows={8}
        />
      ) : (
        <input
          ...
          className="p-2 outline-none text-sm border-2 w-full  font-semibold focus:border-primary valid:border-primary rounded-md smooth-animation peer "
          required={true}
        />
      )}
      <label
